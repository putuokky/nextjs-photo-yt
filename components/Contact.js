  ...
  return (
    <div className='max-w-[1240px] m-auto p-4 h-screen'>
      ...
      <form className='max-w-[600px] m-auto'>
        ...
        <input className='w-full p-3 my-2 border shadow-lg' type='text' placeholder='Subject' />
        <textarea className='w-full p-3 border shadow-lg' name='' id='' cols='30' rows='10' placeholder='Message'></textarea>
